function likelihood = logistic_f(g, lapse, sp, delta, p, disparities, thresholds)
...
% g is guess rate (0.5 for a 2AFC)
% lapse is finger error rate
% sp is the standard deviation (slope)
% delta is the function extent considered for calculation [delta to 1-delta] - typically 0.01
